...
// import '../../data/models/ocr_npwp_model.dart';
// import 'camera_ocr_page.dart';

// class NpwpTemporaryResultPage extends StatelessWidget {
//   final OcrNpwpResultModel result;
//   final String imagePath;
//   final String imagePathCropped;
//   final String imagePathCroppedGrayscale;

//   const NpwpTemporaryResultPage({
//     super.key,
...
//       appBar: AppBar(
//         title: const Text('Hasil Pemindaian NPWP'),
...
//           _buildDataField('NPWP', result.data.npwp ?? '-'),
//           _buildDataField('KPP', result.data.kpp ?? '-'),
//         ],
//       ),
//     );
//   }
...
//       MaterialPageRoute(builder: (_) => CameraOCRPage(ocrType: OcrType.npwp)),
//       (route) => false,
//     );
//   }
// }
